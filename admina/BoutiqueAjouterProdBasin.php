...
if(isset($_POST["Ajouter"]))
{
	...
	$recupAlldeClient='SELECT* from prodbasin where title=:titleStocks, photo=:photoStock, prix=:prixStocks, stock=:stockStocks';
...
{
	$EnregistreUtilisateur= $bdd->prepare('INSERT INTO prodbasin(title, photo, prix, stock)VALUES(?,?,?,?)'); //les ??? sont les contenus du titleClient,email,.. 
	$EnregistreUtilisateur->execute(array($recupTitle, $recupPhoto, $recupPrix, $recupStock
	));

header("Location: BoutiqueAjouterProdBasin.php");
}
}
