...
$affichageCV= $bdd->query("SELECT* from cv where idCv='".$_GET["Modifier"]."'");
...
if(isset($_POST["modifier"]))
{
	...
	$modifierAnneeAutre= $bdd->EXEC("UPDATE cv set anneeAutre='".$recupAnneeAutre."' where idCv='".$_GET["Modifier"]."'");
	$modifierActionCompetence= $bdd->EXEC("UPDATE cv set actionCompetence='".$recupActionCompetence."' where idCv='".$_GET["Modifier"]."'");
